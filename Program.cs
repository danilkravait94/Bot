                ...
                if (u.ChatId == message.Chat.Id.ToString())
                {
                    switch (e.Message.Text)
                    {
                        ...
                        case "/countcal":
                            ...
                            break;
                        case "/information":
                            InlineKeyboardMarkup keyboardInfo = new InlineKeyboardMarkup(new InlineKeyboardButton[][]
                                          {new [] {
                       ...
                       replyMarkup: keyboardAct); break;
                        ...
                        case "/calculate_cal":
                            ...
                            calories *= u.Activity;
                            u.Proteins = (int)((calories * 0.3) / 4 + 1);
                            u.Fats = (int)((calories * 0.3) / 9 + 1);
                            u.Carbohydrates = (int)((calories * 0.3) / 4 + 1);
                            if (u.Goal == "normaly")
                            {
                                if (u.Language == "Russian")
                                {
                                    await BotClient.SendTextMessageAsync(message.Chat, $"Для безопасной потери веса ты" +
                                    $" должен(а) есть {u.Calories} калорий каждый день\n" +
                                        $"и {u.Proteins} белков, {u.Fats} жиров и {u.Carbohydrates} углеводов");
                                }
                                else
                                    await BotClient.SendTextMessageAsync(message.Chat, $"For weight loss {u.Goal} you" +
                                        $" should eat {u.Calories} calories per day\n" +
                                            $"and {u.Proteins} proteins, {u.Fats} fats и {u.Carbohydrates} carbohydrates");
                            }
                            else if (u.Goal == "quickly")
                            {
                                if (u.Language == "Russian")
                                {
                                    await BotClient.SendTextMessageAsync(message.Chat, $"Для быстрой потери веса ты" +
                                    $" должен(а) есть {u.Calories} калорий каждый день\n" +
                                        $"и {u.Proteins} белков, {u.Fats} жиров и {u.Carbohydrates} углеводов");
                                }
                                else
                            ...
                            else if (u.Goal == "extremely")
                            {
                                if (u.Language == "Russian")
                                {
                                    await BotClient.SendTextMessageAsync(message.Chat, $"Для потери веса екстремально быстро ты" +
                                $" должен(а) есть {u.Calories} калорий каждый день\n" +
                                    $"и {u.Proteins} белков, {u.Fats} жиров и {u.Carbohydrates} углеводов");
                                }
                                else
                            ...
                            {
                                calories *= 1.2;
                                u.Proteins = (int)((calories * 0.2) / 4 + 1);
                                u.Fats = (int)((calories * 0.3) / 9 + 1);
                                u.Carbohydrates = (int)((calories * 0.5) / 4 + 1);
                                u.Command = " ";
                                if (u.Language == "Russian")
                    ...
                    using (StreamWriter sw = System.IO.File.AppendText(@"C:\Users\Олег\Desktop\Message.txt"))
                    {
                        sw.WriteLine($"{DateTime.Now} the {u.Name}({u.ChatId}) Write: {e.Message.Text}");
                    }
                }
            }
            DB.SaveChanges();
                ...
                if (u.ChatId == e.CallbackQuery.From.Id.ToString())
                {
                    ...
                    else if ((callbackQuery.Data == "Minus" || callbackQuery.Data == "Norm" || callbackQuery.Data == "Plus") && u.Command == "/Goal")
                    {
                        ...
                        if (callbackQuery.Data == "Minus")
                        {
                            ...
                            else if (u.BodyMassIndex >= 18 && u.BodyMassIndex < 24)
                            {
                                u.Command = "/Minus";
                        ...
                        else if (callbackQuery.Data == "Plus")
                        {
                            ...
                            else if (u.BodyMassIndex >= 24 && u.BodyMassIndex <= 30)
                            {
                                u.Command = "/Plus";
                                InlineKeyboardMarkup keyboardDaNet = new InlineKeyboardMarkup(new InlineKeyboardButton[][]
                                         {new [] {
                                                    InlineKeyboardButton.WithCallbackData("Да","YesPlus"),
                                                    InlineKeyboardButton.WithCallbackData("Нет","NoPlus"),
                                          },
                                        });
                                InlineKeyboardMarkup keyboardYesNo = new InlineKeyboardMarkup(new InlineKeyboardButton[][]
                                        {new [] {
                                                    InlineKeyboardButton.WithCallbackData("Yes","YesPlus"),
                    ...
                    else if (u.Command == "/Lost")
                    {
                        ...
                        u.Proteins = (int)((u.Calories * 0.3) / 4 + 1);
                        u.Fats = (int)((u.Calories * 0.3) / 9 + 1);
                        u.Carbohydrates = (int)((u.Calories * 0.4) / 4 + 1);
                        u.Command = " ";
                        if (u.Language == "Russian")
                        {
                            if (callbackQuery.Data == "normaly")
                    ...
                    else if (u.Command == "/Plus" || u.Command == "/Minus")
                    {
                        ...
                        {
                            u.Goal = "Plus";
                            u.Calories = (int)(u.Calories * 1.2);
                            u.Proteins = (int)((u.Calories * 0.2) / 4 + 1);
                            u.Fats = (int)((u.Calories * 0.3) / 9 + 1);
                            u.Carbohydrates = (int)((u.Calories * 0.5) / 4 + 1);
                            u.Command = " ";
                            if (u.Language == "Russian")
                                await BotClient.SendTextMessageAsync(callbackQuery.From.Id, $"Что ж, для набора веса тебе нужно " +
                        ...
                        else if (callbackQuery.Data == "NoMinus")
                        {
                            ...
                            u.Proteins = (int)((u.Calories * 0.3) / 4 + 1);
                            u.Fats = (int)((u.Calories * 0.3) / 9 + 1);
                            u.Carbohydrates = (int)((u.Calories * 0.4) / 4 + 1); u.Command = " ";
                            if (u.Language == "Russian")
                                await BotClient.SendTextMessageAsync(callbackQuery.From.Id, $"Для безопасной потери веса ты" +
                                $" должен(а) есть {u.Calories} калорий каждый день\n" +
                                    $"и {u.Proteins} белков, {u.Fats} жиров и {u.Carbohydrates} углеводов");
                    ...
                    using (StreamWriter sw = System.IO.File.AppendText(@"C:\Users\Олег\Desktop\Message.txt"))
                    {
                        sw.WriteLine($"{DateTime.Now} the {u.Name}({u.ChatId}) chose: {e.CallbackQuery.Data}");
                    }
                }
            }
            DB.SaveChanges();
